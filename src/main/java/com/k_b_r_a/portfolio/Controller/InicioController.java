...
public class InicioController {
    ...
    @PutMapping("/texts/{id}")
    public Inicio modificar(@RequestBody Inicio nombre,@PathVariable Integer id)
    {
        Inicio inicioActual= inicioService.findById(id);
        inicioActual.setNombre(nombre.getNombre());
        inicioActual.setMessage(nombre.getMessage());
